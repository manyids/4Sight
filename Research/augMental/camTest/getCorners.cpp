...
double camD[] = {9.7693599904368853e+02, 0., 2.4192295352099566e+02, 0.,
       9.7552333155371412e+02, 2.6170665448884301e+02, 0., 0., 1.};
double distCoeffD[] = { 4.3703273729845053e-02, -1.7569227882113452e+00,
       -2.1160875420193101e-03, -2.1509346643375444e-03,
       7.7371081689250332e+00 };
...
{ 
  ...
  glPushMatrix();
    double m[16] = { _d[0],-_d[3],-_d[6],0,
		     ...
		     _d[2],-_d[5],-_d[8],0,
		     tv[0],-tv[1],-tv[2],1};
    //printf("Object Points : %f, %f, %f\n", tv[0], tv[1], tv[2]);
    //cout << "M = "<< endl << " "  << objPM << endl << endl;
    glLoadMatrixd(m);
